...
def get_filters():
    ...
    while True:
        city_input = input('Please enter the city you wish to explore: Chicago, New York City, or Washington: ')
 ...
 # TO DO: get user input for month (all, january, february, ... , june)
    ...
    while True:
        month_input = input('Please enter the month you wish to retrieve data for: January, February, March, April, May, June, or All: ')
...
# TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    ...
    while True:
        day_input = input('Please enter the day of the week you wish to retrieve data for: Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, or All: ')
